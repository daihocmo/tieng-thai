...
Yomitan là một extension (tiện ích mở rộng) trên trình duyệt (Chrome, Chromium-based hoặc Firefox) cho phép bạn tra cứu các từ Tiếng Thái cả nghĩa lẫn cách đọc trên trang web một cách dễ dàng.
...
*nhớ phải thay đổi ngôn ngữ về Tiếng Thái (Thai) nhé.*
...
### Từ điển song ngữ (Thái - Việt)

Chưa tìm được :< khó quá.

*Từ điển song ngữ (Thái - Anh)*

- [Apple](https://drive.proton.me/urls/XZRWCKDM54#Bnq28tvMixEm)

### Từ điển đơn ngữ (Thái - Thái)

- [Pleang Na Nakorn TH-TH](https://drive.proton.me/urls/E4AW4RQY1C#1vVfvTgN5kBi) - Bạn cũng có thể tải từ điển *LEXiTRON TH-EN dictionary (Thái - Anh)* trong thư mục Drive này.
...
Trên thanh công cụ trình duyệt, nếu bạn chọn biểu tượng Yomitan, sau đó chọn biểu tượng ![search icon](img/yomitan-search.png) hoặc dùng tổ hợp phím tắt `Alt+ Insert`, bạn có thể truy cập vào "Yomitan Search" - bạn có thể sử dụng Yomitan như một từ điển Tiếng Thái riêng (Hoàn toàn Offline).

Có thể chỉnh kích cỡ Pop-up trong cài đặt và cả giao diện tối nữa.

## Từ điển đo độ phổ biến của từ

Yomitan hỗ trợ từ điển tần suất để cho bạn biết độ phổ biến của từ này (Nhưng mà chưa tìm được từ điển đo độ phổ biến của từ nào hỗ trợ Tiếng Thái cả)
